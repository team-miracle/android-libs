...
public  void setAutomaticGainControlLevelInDb(double agcLevelDb) { throw new RuntimeException("Stub!"); }
public  void resetAutomaticGainControlLevel() { throw new RuntimeException("Stub!"); }
