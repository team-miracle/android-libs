...
public  GnssNavigationMessage() { throw new RuntimeException("Stub!"); }
public  void set(android.location.GnssNavigationMessage navigationMessage) { throw new RuntimeException("Stub!"); }
public  void reset() { throw new RuntimeException("Stub!"); }
public  int getType() { throw new RuntimeException("Stub!"); }
public  void setType(int value) { throw new RuntimeException("Stub!"); }
...
public  void setMessageId(int value) { throw new RuntimeException("Stub!"); }
public  int getSubmessageId() { throw new RuntimeException("Stub!"); }
public  void setSubmessageId(int value) { throw new RuntimeException("Stub!"); }
...
public  void setStatus(int value) { throw new RuntimeException("Stub!"); }
