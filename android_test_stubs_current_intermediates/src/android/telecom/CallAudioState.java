...
public  CallAudioState(boolean isMuted, int route, int supportedRouteMask, android.bluetooth.BluetoothDevice activeBluetoothDevice, java.util.Collection<android.bluetooth.BluetoothDevice> supportedBluetoothDevices) { throw new RuntimeException("Stub!"); }
