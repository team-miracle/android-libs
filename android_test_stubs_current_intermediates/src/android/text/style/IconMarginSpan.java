...
{
public  IconMarginSpan(android.graphics.Bitmap bitmap) { throw new RuntimeException("Stub!"); }
public  IconMarginSpan(android.graphics.Bitmap bitmap, int pad) { throw new RuntimeException("Stub!"); }
