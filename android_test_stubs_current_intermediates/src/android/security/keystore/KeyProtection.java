...
public  android.security.keystore.KeyProtection.Builder setBoundToSpecificSecureUserId(long secureUserId) { throw new RuntimeException("Stub!"); }
...
public  long getBoundToSpecificSecureUserId() { throw new RuntimeException("Stub!"); }
