...
public  boolean isQuotaSupported(java.util.UUID storageUuid) { throw new RuntimeException("Stub!"); }
public  boolean isReservedSupported(java.util.UUID storageUuid) { throw new RuntimeException("Stub!"); }
