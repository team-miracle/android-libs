...
public  android.media.PlaybackParams setAudioStretchMode(int audioStretchMode) { throw new RuntimeException("Stub!"); }
public  int getAudioStretchMode() { throw new RuntimeException("Stub!"); }
