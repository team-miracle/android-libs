...
{
public abstract  void onParameterChange(android.media.audiofx.AudioEffect effect, int status, byte[] param, byte[] value);
}
...
public static  boolean isEffectTypeAvailable(java.util.UUID type) { throw new RuntimeException("Stub!"); }
public  int setEnabled(boolean enabled) throws java.lang.IllegalStateException { throw new RuntimeException("Stub!"); }
public  int setParameter(byte[] param, byte[] value) throws java.lang.IllegalStateException { throw new RuntimeException("Stub!"); }
public  int setParameter(int param, int value) throws java.lang.IllegalStateException { throw new RuntimeException("Stub!"); }
public  int setParameter(int param, short value) throws java.lang.IllegalStateException { throw new RuntimeException("Stub!"); }
public  int setParameter(int param, byte[] value) throws java.lang.IllegalStateException { throw new RuntimeException("Stub!"); }
public  int setParameter(int[] param, int[] value) throws java.lang.IllegalStateException { throw new RuntimeException("Stub!"); }
public  int setParameter(int[] param, byte[] value) throws java.lang.IllegalStateException { throw new RuntimeException("Stub!"); }
public  int getParameter(byte[] param, byte[] value) throws java.lang.IllegalStateException { throw new RuntimeException("Stub!"); }
public  int getParameter(int param, byte[] value) throws java.lang.IllegalStateException { throw new RuntimeException("Stub!"); }
public  int getParameter(int param, int[] value) throws java.lang.IllegalStateException { throw new RuntimeException("Stub!"); }
public  int getParameter(int param, short[] value) throws java.lang.IllegalStateException { throw new RuntimeException("Stub!"); }
public  int getParameter(int[] param, short[] value) throws java.lang.IllegalStateException { throw new RuntimeException("Stub!"); }
...
public  void setParameterListener(android.media.audiofx.AudioEffect.OnParameterChangeListener listener) { throw new RuntimeException("Stub!"); }
public static  boolean isError(int status) { throw new RuntimeException("Stub!"); }
public static  int byteArrayToInt(byte[] valueBuf) { throw new RuntimeException("Stub!"); }
public static  byte[] intToByteArray(int value) { throw new RuntimeException("Stub!"); }
public static  short byteArrayToShort(byte[] valueBuf) { throw new RuntimeException("Stub!"); }
public static  byte[] shortToByteArray(short value) { throw new RuntimeException("Stub!"); }
...
static { EFFECT_TYPE_AEC = null; EFFECT_TYPE_AGC = null; EFFECT_TYPE_BASS_BOOST = null; EFFECT_TYPE_DYNAMICS_PROCESSING = null; EFFECT_TYPE_ENV_REVERB = null; EFFECT_TYPE_EQUALIZER = null; EFFECT_TYPE_LOUDNESS_ENHANCER = null; EFFECT_TYPE_NS = null; EFFECT_TYPE_NULL = null; EFFECT_TYPE_PRESET_REVERB = null; EFFECT_TYPE_VIRTUALIZER = null; }
}
