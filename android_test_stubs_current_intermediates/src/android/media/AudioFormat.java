...
public static  int channelCountFromInChannelMask(int mask) { throw new RuntimeException("Stub!"); }
public static  int channelCountFromOutChannelMask(int mask) { throw new RuntimeException("Stub!"); }
public static  int getBytesPerSample(int audioFormat) { throw new RuntimeException("Stub!"); }
public static  boolean isEncodingLinearPcm(int audioFormat) { throw new RuntimeException("Stub!"); }
