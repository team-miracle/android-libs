...
public  KeyboardShortcutGroup(java.lang.CharSequence label, java.util.List<android.view.KeyboardShortcutInfo> items, boolean isSystemGroup) { throw new RuntimeException("Stub!"); }
public  KeyboardShortcutGroup(java.lang.CharSequence label, boolean isSystemGroup) { throw new RuntimeException("Stub!"); }
...
public  boolean isSystemGroup() { throw new RuntimeException("Stub!"); }
