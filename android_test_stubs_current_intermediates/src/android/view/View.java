...
public  void setAutofilled(boolean isAutofilled) { throw new RuntimeException("Stub!"); }
...
public final  void setFocusedInCluster() { throw new RuntimeException("Stub!"); }
@android.view.ViewDebug.ExportedProperty(category="focus")
...
public  boolean restoreFocusInCluster(int direction) { throw new RuntimeException("Stub!"); }
public  boolean restoreFocusNotInCluster() { throw new RuntimeException("Stub!"); }
...
public  boolean isDefaultFocusHighlightNeeded(android.graphics.drawable.Drawable background, android.graphics.drawable.Drawable foreground) { throw new RuntimeException("Stub!"); }
...
public  android.view.View getTooltipView() { throw new RuntimeException("Stub!"); }
public static  boolean isDefaultFocusHighlightEnabled() { throw new RuntimeException("Stub!"); }
