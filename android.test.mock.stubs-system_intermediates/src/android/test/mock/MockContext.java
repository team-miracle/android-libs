...
public  void sendBroadcastAsUser(android.content.Intent intent, android.os.UserHandle user, java.lang.String receiverPermission, android.os.Bundle options) { throw new RuntimeException("Stub!"); }
...
public  java.io.File getPreloadsFileCache() { throw new RuntimeException("Stub!"); }
}
