...
public interface Map<K, V> {
     ...
     */
    @Nullable V put(@NullFromTypeParam K key, @NullFromTypeParam V value);
     ...
     */
    void putAll(@NonNull Map<? extends @NullFromTypeParam K, ? extends @NullFromTypeParam V> m);
     ...
     */
    @NonNull Set<@NullFromTypeParam K> keySet();
     ...
     */
    @NonNull Collection<@NullFromTypeParam V> values();
     ...
     */
    @NonNull Set<Map.@NonNull Entry<@NullFromTypeParam K, @NullFromTypeParam V>> entrySet();
    ...
    interface Entry<K, V> {
         ...
         *         removed from the backing map.
         */
        @NullFromTypeParam V setValue(@NullFromTypeParam V value);
         ...
         * @since 1.8
         */
        public static <K extends Comparable<? super K>, V> @NonNull Comparator<Map.@NonNull Entry<@NonNull K, @Nullable V>> comparingByKey() {
         ...
         * @since 1.8
         */
        public static <K, V extends Comparable<? super V>> @NonNull Comparator<Map.@NonNull Entry<@Nullable K, @NonNull V>> comparingByValue() {
            return (Comparator<Map.Entry<K, V>> & Serializable)
         ...
         * @since 1.8
         */
        public static <K, V> @NonNull Comparator<Map.@NonNull Entry<@NullFromTypeParam K, @Nullable V>> comparingByKey(@NonNull Comparator<? super @NullFromTypeParam K> cmp) {
         ...
         * @since 1.8
         */
        public static <K, V> @NonNull Comparator<Map.@NonNull Entry<@Nullable K, @NullFromTypeParam V>> comparingByValue(@NonNull Comparator<? super @NullFromTypeParam V> cmp) {
            Objects.requireNonNull(cmp);
            return (Comparator<Map.Entry<K, V>> & Serializable)
     ...
     * @since 1.8
     */
    default void forEach(@NonNull BiConsumer<? super @NullFromTypeParam K, ? super @NullFromTypeParam V> action) {
     ...
     * @since 1.8
     */
    default void replaceAll(@NonNull BiFunction<? super @NullFromTypeParam K, ? super @NullFromTypeParam V, ? extends @NullFromTypeParam V> function) {
     ...
     * @since 1.8
     */
    default @Nullable V putIfAbsent(@NullFromTypeParam K key, @NullFromTypeParam V value) {
        V v = get(key);
        if (v == null) {
            v = put(key, value);
        }
     ...
     * @since 1.8
     */
    default boolean replace(@NullFromTypeParam K key, @Nullable V oldValue, @NullFromTypeParam V newValue) {
        Object curValue = get(key);
     ...
     * @since 1.8
     */
    default @Nullable V replace(@NullFromTypeParam K key, @NullFromTypeParam V value) {
        V curValue;
     ...
     * @since 1.8
     */
    default @Nullable V computeIfAbsent(@NullFromTypeParam K key,
            @NonNull Function<? super @NullFromTypeParam K, ? extends @Nullable V> mappingFunction) {
     ...
     * @since 1.8
     */
    default @Nullable V computeIfPresent(@NullFromTypeParam K key,
            @NonNull BiFunction<? super @NullFromTypeParam K, ? super @NonNull V, ? extends @Nullable V> remappingFunction) {
     ...
     * @since 1.8
     */
    default @Nullable V compute(@NullFromTypeParam K key,
            @NonNull BiFunction<? super @NullFromTypeParam K, ? super @Nullable V, ? extends @Nullable V> remappingFunction) {
        Objects.requireNonNull(remappingFunction);
        V oldValue = get(key);
     ...
     * @since 1.8
     */
    default @Nullable V merge(@NullFromTypeParam K key, @NonNull V value,
            @NonNull BiFunction<? super @NonNull V, ? super @NonNull V, ? extends @Nullable V> remappingFunction) {
        Objects.requireNonNull(remappingFunction);
