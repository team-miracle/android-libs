                                      ...
                                      Comparable<Boolean>
{
     ...
     * @since  1.4
     */
    public static @NonNull Boolean valueOf(boolean b) {
        return (b ? TRUE : FALSE);
    }
     ...
     */
    public static @NonNull Boolean valueOf(@Nullable String s) {
     ...
     * @since 1.4
     */
    public static @NonNull String toString(boolean b) {
        return b ? "true" : "false";
    }
   ...
   /**
     ...
     */
    public static @Nullable boolean getBoolean(@NonNull String name) {
     ...
     * @since  1.5
     */
    public int compareTo(@NonNull Boolean b) {
