...
public final class System {
     ...
     * @since   JDK1.1
     */
    public static void setIn(@Nullable InputStream in) {
        setIn0(in);
    }
     ...
     * @since   JDK1.1
     */
    public static void setOut(@Nullable PrintStream out) {
        setOut0(out);
    }
     ...
     * @since   JDK1.1
     */
    public static void setErr(@Nullable PrintStream err) {
        setErr0(err);
    }
     ...
     */
    public static
    void setSecurityManager(final @Nullable SecurityManager s) {
        if (s != null) {
     ...
     */
    @FastNative
    public static native void arraycopy(@NonNull Object src,  @NonNull int  srcPos,
     ...
     */
    public static @NonNull Properties getProperties() {
     ...
     * @see        java.lang.System#getProperties()
     */
    public static @Nullable String getProperty(@NonNull String key, @Nullable String def) {
        checkKey(key);
        SecurityManager sm = getSecurityManager();
        if (sm != null) {
            sm.checkPropertyAccess(key);
     ...
     * @since  1.5
     */
    public static java.util.@NonNull Map<String,String> getenv() {
        SecurityManager sm = getSecurityManager();
        if (sm != null) {
     ...
     */
    @CallerSensitive
    public static void load(@NonNull String filename) {
     ...
     * @since      1.2
     */
    public static native @NonNull String mapLibraryName(@NonNull String libname);
