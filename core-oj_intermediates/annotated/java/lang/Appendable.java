...
public interface Appendable {
     ...
     */
    @NonNull Appendable append(@Nullable CharSequence csq) throws IOException;
     ...
     *          If an I/O error occurs
     */
    @NonNull Appendable append(@Nullable CharSequence csq, int start, int end) throws IOException;
     ...
     *          If an I/O error occurs
     */
    @NonNull Appendable append(char c) throws IOException;
}
