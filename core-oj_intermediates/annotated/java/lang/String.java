...
public final class String
     ...
     *         A {@code String}
     */
    public String(@NonNull String original) {
        // Android-changed: Constructor unsupported as all calls are intercepted by the runtime.
        throw new UnsupportedOperationException("Use StringFactory instead.");
    }
     ...
     */
    public String(char value @NonNull []) {
        // Android-changed: Constructor unsupported as all calls are intercepted by the runtime.
        throw new UnsupportedOperationException("Use StringFactory instead.");
    }
     ...
     */
    public String(char value @NonNull [], int offset, int count) {
        // Android-changed: Constructor unsupported as all calls are intercepted by the runtime.
        throw new UnsupportedOperationException("Use StringFactory instead.");
    }
     ...
     * @since  1.5
     */
    public String(int @NonNull [] codePoints, int offset, int count) {
        // Android-changed: Constructor unsupported as all calls are intercepted by the runtime.
        throw new UnsupportedOperationException("Use StringFactory instead.");
    }
     ...
     */
    @Deprecated
    public String(byte ascii @NonNull [], int hibyte, int offset, int count) {
        // Android-changed: Constructor unsupported as all calls are intercepted by the runtime.
        throw new UnsupportedOperationException("Use StringFactory instead.");
    }
     ...
     */
    @Deprecated
    public String(byte ascii @NonNull [], int hibyte) {
        // Android-changed: Constructor unsupported as all calls are intercepted by the runtime.
        throw new UnsupportedOperationException("Use StringFactory instead.");
    }
     ...
     * @since  JDK1.1
     */
    public String(byte bytes @NonNull [], int offset, int length, @NonNull String charsetName)
            throws UnsupportedEncodingException {
        // Android-changed: Constructor unsupported as all calls are intercepted by the runtime.
        throw new UnsupportedOperationException("Use StringFactory instead.");
    }
     ...
     * @since  1.6
     */
    public String(byte bytes @NonNull [], int offset, int length, @NonNull Charset charset) {
        // Android-changed: Constructor unsupported as all calls are intercepted by the runtime.
        throw new UnsupportedOperationException("Use StringFactory instead.");
    }
     ...
     * @since  JDK1.1
     */
    public String(byte bytes @NonNull [], @NonNull String charsetName)
            throws UnsupportedEncodingException {
        // Android-changed: Constructor unsupported as all calls are intercepted by the runtime.
        throw new UnsupportedOperationException("Use StringFactory instead.");
    }
     ...
     * @since  1.6
     */
    public String(byte bytes @NonNull [], @NonNull Charset charset) {
        // Android-changed: Constructor unsupported as all calls are intercepted by the runtime.
        throw new UnsupportedOperationException("Use StringFactory instead.");
    }
     ...
     * @since  JDK1.1
     */
    public String(byte bytes @NonNull [], int offset, int length) {
        // Android-changed: Constructor unsupported as all calls are intercepted by the runtime.
        throw new UnsupportedOperationException("Use StringFactory instead.");
    }
     ...
     * @since  JDK1.1
     */
    public String(byte bytes @NonNull []) {
        // Android-changed: Constructor unsupported as all calls are intercepted by the runtime.
        throw new UnsupportedOperationException("Use StringFactory instead.");
    }
     ...
     * @since  1.5
     */
    public String(@NonNull StringBuilder builder) {
        // Android-changed: Constructor unsupported as all calls are intercepted by the runtime.
        throw new UnsupportedOperationException("Use StringFactory instead.");
    }
     ...
     */
    @Deprecated
    String(int offset, int count, char @NonNull [] value) {
        throw new UnsupportedOperationException("Use StringFactory instead.");
    }
     ...
     *                {@code dst.length}</ul>
     */
    public void getChars(int srcBegin, int srcEnd, char dst @NonNull [], int dstBegin) {
     ...
     */
    @Deprecated
    public void getBytes(int srcBegin, int srcEnd, byte dst @NonNull [], int dstBegin) {
        if (srcBegin < 0) {
            throw new StringIndexOutOfBoundsException(this, srcBegin);
        }
        if (srcEnd > length()) {
     ...
     * @since  JDK1.1
     */
    public byte @NonNull [] getBytes(@NonNull String charsetName)
            throws UnsupportedEncodingException {
    ...
    // BEGIN Android-changed: Replace with implementation in runtime to access chars (see above).
    @FastNative
    public native int compareTo(@NonNull String anotherString);
    // END Android-changed: Replace with implementation in runtime to access chars (see above).
     ...
     *          {@code false} otherwise.
     */
    public boolean regionMatches(int toffset, @NonNull String other, int ooffset,
            int len) {
        int to = toffset;
        int po = ooffset;
     ...
     */
    public @NonNull String substring(int beginIndex) {
        if (beginIndex < 0) {
     ...
     *             {@code endIndex}.
     */
    public @NonNull String substring(int beginIndex, int endIndex) {
        if (beginIndex < 0) {
            throw new StringIndexOutOfBoundsException(this, beginIndex);
        }
        if (endIndex > length()) {
     ...
     * @spec JSR-51
     */
    public @NonNull CharSequence subSequence(int beginIndex, int endIndex) {
    ...
    // BEGIN Android-changed: Replace with implementation in runtime to access chars (see above).
    @FastNative
    public native @NonNull String concat(@NonNull String str);
    // END Android-changed: Replace with implementation in runtime to access chars (see above).
     ...
     */
    public @NonNull String replace(char oldChar, char newChar) {
     ...
     * @spec JSR-51
     */
    public @NonNull String replaceFirst(@NonNull String regex, @NonNull String replacement) {
     ...
     * @spec JSR-51
     */
    public @NonNull String replaceAll(@NonNull String regex, @NonNull String replacement) {
     ...
     * @since 1.5
     */
    public @NonNull String replace(@NonNull CharSequence target, @NonNull CharSequence replacement) {
     ...
     * @spec JSR-51
     */
    public @NonNull String @NonNull [] split(@NonNull String regex, int limit) {
     ...
     * @spec JSR-51
     */
    public @NonNull String @NonNull [] split(@NonNull String regex) {
     ...
     * @since 1.8
     */
    public static @NonNull String join(@NonNull CharSequence delimiter, @Nullable CharSequence @NonNull ... elements) {
     ...
     * @since 1.8
     */
    public static @NonNull String join(@NonNull CharSequence delimiter,
            @NonNull Iterable<? extends @Nullable CharSequence> elements) {
        Objects.requireNonNull(delimiter);
        Objects.requireNonNull(elements);
        StringJoiner joiner = new StringJoiner(delimiter);
        for (CharSequence cs: elements) {
     ...
     * @since   1.1
     */
    public @NonNull String toLowerCase(@NonNull Locale locale) {
     ...
     */
    public @NonNull String toLowerCase() {
     ...
     * @since   1.1
     */
    public @NonNull String toUpperCase(@NonNull Locale locale) {
        // Android-changed: Replace custom code with call to new CaseMapper class.
     ...
     * @see     java.lang.String#toUpperCase(Locale)
     */
    public @NonNull String toUpperCase() {
    ...
    // BEGIN Android-changed: Replace with implementation in runtime to access chars (see above).
    @FastNative
    public native char @NonNull [] toCharArray();
    // END Android-changed: Replace with implementation in runtime to access chars (see above).
     ...
     * @since  1.5
     */
    public static @NonNull String format(@NonNull String format, @Nullable Object @NonNull ... args) {
     ...
     * @since  1.5
     */
    public static @NonNull String format(@NonNull Locale l, @NonNull String format, @Nullable Object @NonNull ... args) {
     ...
     * @see     java.lang.Object#toString()
     */
    public static @NonNull String valueOf(@Nullable Object obj) {
     ...
     *          character array.
     */
    public static @NonNull String valueOf(char data @NonNull []) {
     ...
     *          {@code data.length}.
     */
    public static @NonNull String valueOf(char data @NonNull [], int offset, int count) {
        // Android-changed: Replace constructor call with call to new StringFactory class.
     ...
     *          {@code data.length}.
     */
    public static @NonNull String copyValueOf(char data @NonNull [], int offset, int count) {
        // Android-changed: Replace constructor call with call to new StringFactory class.
     ...
     *          character array.
     */
    public static @NonNull String copyValueOf(char data @NonNull []) {
        // Android-changed: Replace constructor call with call to new StringFactory class.
        // return new String(data);
        return StringFactory.newStringFromChars(data);
    }
     ...
     */
    public static @NonNull String valueOf(boolean b) {
        return b ? "true" : "false";
    }
     ...
     */
    public static @NonNull String valueOf(char c) {
        // Android-changed: Replace constructor call with call to new StringFactory class.
        // char data[] = {c};
     ...
     */
    public static @NonNull String valueOf(int i) {
     ...
     */
    public static @NonNull String valueOf(long l) {
     ...
     */
    public static @NonNull String valueOf(float f) {
     ...
     */
    public static @NonNull String valueOf(double d) {
    ...
    public native @NonNull String intern();
}
