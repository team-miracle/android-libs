...
class Character implements java.io.Serializable, Comparable<Character> {
    ...
    * Strong bidirectional character type "AL" in the Unicode specification.
    ...
    public static class Subset  {
         ...
         */
        protected Subset(@NonNull String name) {
            if (name == null) {
    ...
    public static final class UnicodeBlock extends Subset {
         ...
         * @since 1.5
         */
        public static final @NonNull UnicodeBlock forName(@NonNull String blockName) {
    ...
    public static enum UnicodeScript {
         ...
         *
         */
        public static @NonNull UnicodeScript of(int codePoint) {
            if (!isValidCodePoint(codePoint))
                throw new IllegalArgumentException();
         ...
         */
        public static final @NonNull UnicodeScript forName(@NonNull String scriptName) {
     ...
     * @since  1.5
     */
    public static @NonNull Character valueOf(char c) {
        if (c <= 127) { // must cache
     ...
     * @since 1.4
     */
    public static @NonNull String toString(char c) {
     ...
     * @since  1.5
     */
    public static int codePointAt(@NonNull CharSequence seq, int index) {
     ...
     * @since  1.5
     */
    public static int codePointAt(char @NonNull [] a, int index) {
     ...
     * @since  1.5
     */
    public static int codePointAt(char @NonNull [] a, int index, int limit) {
     ...
     * @since  1.5
     */
    public static int codePointBefore(@NonNull CharSequence seq, int index) {
        char c2 = seq.charAt(--index);
     ...
     * @since  1.5
     */
    public static int codePointBefore(char @NonNull [] a, int index) {
     ...
     * @since  1.5
     */
    public static int codePointBefore(char @NonNull [] a, int index, int start) {
     ...
     * @since  1.5
     */
    public static int toChars(int codePoint, char @NonNull [] dst, int dstIndex) {
     ...
     * @since  1.5
     */
    public static char @NonNull [] toChars(int codePoint) {
        if (isBmpCodePoint(codePoint)) {
     ...
     * @since  1.5
     */
    public static int codePointCount(@NonNull CharSequence seq, int beginIndex, int endIndex) {
     ...
     * @since  1.5
     */
    public static int codePointCount(char @NonNull [] a, int offset, int count) {
     ...
     * @since 1.5
     */
    public static int offsetByCodePoints(@NonNull CharSequence seq, int index,
                                         int codePointOffset) {
        int length = seq.length();
     ...
     * @since 1.5
     */
    public static int offsetByCodePoints(char @NonNull [] a, int start, int count,
     ...
     * @since   1.2
     */
    public int compareTo(@NonNull Character anotherCharacter) {
