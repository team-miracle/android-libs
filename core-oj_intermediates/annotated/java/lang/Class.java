...
public final class Class<T> implements java.io.Serializable,
     ...
     * @since 1.8
     */
    public @NonNull String toGenericString() {
        if (isPrimitive()) {
            return toString();
        } else {
     ...
     */
    @CallerSensitive
    public static @NonNull Class<?> forName(@NonNull String className)
     ...
     */
    @CallerSensitive
    public static @NonNull Class<?> forName(@NonNull String name, boolean initialize,
     ...
     */
    @FastNative
    public native @NonNull T newInstance() throws InstantiationException, IllegalAccessException;
     ...
     * @since JDK1.1
     */
    public boolean isAssignableFrom(@NonNull Class<?> cls) {
        if (this == cls) {
     ...
     */
    public @Nullable Class<? super T> getSuperclass() {
     ...
     */
    public @NonNull Class<?> @NonNull [] getInterfaces() {
        if (isArray()) {
     ...
     * @since 1.5
     */
    public @NonNull Type @NonNull [] getGenericInterfaces() {
        Type[] result;
     ...
     * @since   JDK1.1
     */
    public @NonNull Object @Nullable [] getSigners() {
        return null;
    }
    ...
    // Android-changed: Removed SecurityException
    @FastNative
    public native @Nullable Class<?> getEnclosingClass();
     ...
     */
    @CallerSensitive
    public @NonNull Class<?> @NonNull [] getClasses() {
     ...
     */
    @CallerSensitive
    public @NonNull Field @NonNull [] getFields() throws SecurityException {
     ...
     */
    @CallerSensitive
    public @NonNull Method @NonNull [] getMethods() throws SecurityException {
     ...
     */
    @CallerSensitive
    public @NonNull Constructor<?> @NonNull [] getConstructors() throws SecurityException {
     ...
     */
    @CallerSensitive
    public @NonNull Method getMethod(@NonNull String name, @NonNull Class<?> @Nullable ... parameterTypes)
     ...
     * @since JDK1.1
     */
    public @NonNull Constructor<T> getConstructor(@NonNull Class<?> @Nullable ... parameterTypes)
        throws NoSuchMethodException, SecurityException {
    ...
    // Android-changed: Removed SecurityException
    @FastNative
    public native @NonNull Class<?> @NonNull [] getDeclaredClasses();
    ...
    // Android-changed: Removed SecurityException
    @FastNative
    public native @NonNull Field @NonNull [] getDeclaredFields();
     ...
     * @since JDK1.1
     */
    public @NonNull Method @NonNull [] getDeclaredMethods() throws SecurityException {
     ...
     * @since JDK1.1
     */
    public @NonNull Constructor<?> @NonNull [] getDeclaredConstructors() throws SecurityException {
    ...
    // Android-changed: Removed SecurityException
    @FastNative
    public native @NonNull Field getDeclaredField(@NonNull String name) throws NoSuchFieldException;
     ...
     */
    @CallerSensitive
    public @NonNull Method getDeclaredMethod(@NonNull String name, @NonNull Class<?> @Nullable ... parameterTypes)
        throws NoSuchMethodException, SecurityException {
     ...
     */
    @CallerSensitive
    public @NonNull Constructor<T> getDeclaredConstructor(@NonNull Class<?> @Nullable ... parameterTypes)
        throws NoSuchMethodException, SecurityException {
     ...
     * @since  JDK1.1
     */
     public @Nullable InputStream getResourceAsStream(@NonNull String name) {
     ...
     * @since  JDK1.1
     */
    public java.net.@Nullable URL getResource(@NonNull String name) {
        name = resolveName(name);
        ClassLoader cl = getClassLoader();
        if (cl==null) {
            // A system class.
     ...
     * @since 1.2
     */
    public java.security.@Nullable ProtectionDomain getProtectionDomain() {
        return null;
    }
     ...
     */
    @SuppressWarnings("unchecked")
    public <U> Class<? extends U> asSubclass(@NonNull Class<U> clazz) {
     ...
     */
    @Override
    public <A extends Annotation> @NonNull A @NonNull [] getAnnotationsByType(@NonNull Class<A> annotationClass) {
     ...
     */
    @Override
    public @NonNull Annotation @NonNull [] getAnnotations() {
        /*
    ...
    @Override
    @FastNative
    public native <A extends Annotation> @Nullable A getDeclaredAnnotation(@NonNull Class<A> annotationClass);
    ...
    @Override
    @FastNative
    public native @NonNull Annotation @NonNull [] getDeclaredAnnotations();
