...
public final class Method extends Executable  {
    ...
    public @NonNull TypeVariable<Method> @NonNull [] getTypeParameters() {
     ...
     */
    public @NonNull Class<?> getReturnType() {
     ...
     * @since 1.5
     */
    public @NonNull Type getGenericReturnType() {
     ...
     */
    @Override
    public @NonNull Class<?> @NonNull [] getParameterTypes() {
    ...
    @FastNative
    public native @NonNull Class<?> @NonNull [] getExceptionTypes();
     ...
     */
    @Override
    public @NonNull Annotation @NonNull [] @NonNull [] getParameterAnnotations() {
