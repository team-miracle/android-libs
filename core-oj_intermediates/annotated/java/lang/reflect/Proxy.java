...
public class Proxy implements java.io.Serializable {
     ...
     */
    @CallerSensitive
    public static @NonNull Class<?> getProxyClass(ClassLoader loader,
                                         Class<?>... interfaces)
    ...
    */
     ...
     */
    @CallerSensitive
    public static @NonNull Object newProxyInstance(ClassLoader loader,
                                          Class<?>[] interfaces,
                                          InvocationHandler h)
        throws IllegalArgumentException
    {
    ...
    */
     ...
     */
    @CallerSensitive
    public static @NonNull InvocationHandler getInvocationHandler(Object proxy)
        throws IllegalArgumentException
    {
        /*
