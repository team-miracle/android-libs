 ...
 * Original file: packages/services/Car/car-lib/src/android/car/diagnostic/ICarDiagnostic.aidl
 */
...
mRemote.transact(Stub.TRANSACTION_registerOrUpdateDiagnosticListener, _data, _reply, 0);
...
try {
_data.writeInterfaceToken(DESCRIPTOR);
mRemote.transact(Stub.TRANSACTION_getLatestLiveFrame, _data, _reply, 0);
_reply.readException();
if ((0!=_reply.readInt())) {
...
try {
_data.writeInterfaceToken(DESCRIPTOR);
mRemote.transact(Stub.TRANSACTION_getFreezeFrameTimestamps, _data, _reply, 0);
_reply.readException();
...
mRemote.transact(Stub.TRANSACTION_getFreezeFrame, _data, _reply, 0);
_reply.readException();
if ((0!=_reply.readInt())) {
_result = android.car.diagnostic.CarDiagnosticEvent.CREATOR.createFromParcel(_reply);
}
...
mRemote.transact(Stub.TRANSACTION_clearFreezeFrames, _data, _reply, 0);
_reply.readException();
_result = (0!=_reply.readInt());
}
finally {
...
mRemote.transact(Stub.TRANSACTION_unregisterDiagnosticListener, _data, _reply, 0);
_reply.readException();
}
finally {
_reply.recycle();
...
try {
_data.writeInterfaceToken(DESCRIPTOR);
mRemote.transact(Stub.TRANSACTION_isLiveFrameSupported, _data, _reply, 0);
_reply.readException();
_result = (0!=_reply.readInt());
}
finally {
...
try {
_data.writeInterfaceToken(DESCRIPTOR);
mRemote.transact(Stub.TRANSACTION_isFreezeFrameNotificationSupported, _data, _reply, 0);
_reply.readException();
_result = (0!=_reply.readInt());
}
finally {
...
try {
_data.writeInterfaceToken(DESCRIPTOR);
mRemote.transact(Stub.TRANSACTION_isGetFreezeFrameSupported, _data, _reply, 0);
_reply.readException();
_result = (0!=_reply.readInt());
}
finally {
...
try {
_data.writeInterfaceToken(DESCRIPTOR);
mRemote.transact(Stub.TRANSACTION_isClearFreezeFramesSupported, _data, _reply, 0);
_reply.readException();
_result = (0!=_reply.readInt());
}
finally {
...
try {
_data.writeInterfaceToken(DESCRIPTOR);
mRemote.transact(Stub.TRANSACTION_isSelectiveClearFreezeFramesSupported, _data, _reply, 0);
_reply.readException();
_result = (0!=_reply.readInt());
}
finally {
