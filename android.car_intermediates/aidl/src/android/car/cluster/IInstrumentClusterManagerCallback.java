 ...
 * Original file: packages/services/Car/car-lib/src/android/car/cluster/IInstrumentClusterManagerCallback.aidl
 */
...
mRemote.transact(Stub.TRANSACTION_setClusterActivityState, _data, null, android.os.IBinder.FLAG_ONEWAY);
}
finally {
_data.recycle();
}
