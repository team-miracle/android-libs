 ...
 * Original file: packages/services/Car/car-lib/src/android/car/storagemonitoring/ICarStorageMonitoring.aidl
 */
...
mRemote.transact(Stub.TRANSACTION_getPreEolIndicatorStatus, _data, _reply, 0);
...
try {
_data.writeInterfaceToken(DESCRIPTOR);
mRemote.transact(Stub.TRANSACTION_getWearEstimate, _data, _reply, 0);
_reply.readException();
if ((0!=_reply.readInt())) {
...
try {
_data.writeInterfaceToken(DESCRIPTOR);
mRemote.transact(Stub.TRANSACTION_getWearEstimateHistory, _data, _reply, 0);
_reply.readException();
...
try {
_data.writeInterfaceToken(DESCRIPTOR);
mRemote.transact(Stub.TRANSACTION_getBootIoStats, _data, _reply, 0);
_reply.readException();
...
try {
_data.writeInterfaceToken(DESCRIPTOR);
mRemote.transact(Stub.TRANSACTION_getAggregateIoStats, _data, _reply, 0);
_reply.readException();
_result = _reply.createTypedArrayList(android.car.storagemonitoring.IoStatsEntry.CREATOR);
}
finally {
...
try {
_data.writeInterfaceToken(DESCRIPTOR);
mRemote.transact(Stub.TRANSACTION_getIoStatsDeltas, _data, _reply, 0);
_reply.readException();
...
try {
_data.writeInterfaceToken(DESCRIPTOR);
mRemote.transact(Stub.TRANSACTION_getShutdownDiskWriteAmount, _data, _reply, 0);
_reply.readException();
