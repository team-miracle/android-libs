 ...
 * Original file: packages/services/Car/car-lib/src/android/car/vms/IVmsPublisherClient.aidl
 */
...
mRemote.transact(Stub.TRANSACTION_setVmsPublisherService, _data, null, android.os.IBinder.FLAG_ONEWAY);
}
finally {
_data.recycle();
}
...
mRemote.transact(Stub.TRANSACTION_onVmsSubscriptionChange, _data, null, android.os.IBinder.FLAG_ONEWAY);
}
finally {
_data.recycle();
}
