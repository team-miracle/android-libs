 ...
 * Original file: packages/services/Car/car-lib/src/android/car/vms/IVmsSubscriberService.aidl
 */
...
mRemote.transact(Stub.TRANSACTION_addVmsSubscriberToNotifications, _data, _reply, 0);
...
mRemote.transact(Stub.TRANSACTION_addVmsSubscriber, _data, _reply, 0);
_reply.readException();
}
finally {
_reply.recycle();
...
_data.writeInterfaceToken(DESCRIPTOR);
_data.writeStrongBinder((((subscriber!=null))?(subscriber.asBinder()):(null)));
mRemote.transact(Stub.TRANSACTION_addVmsSubscriberPassive, _data, _reply, 0);
_reply.readException();
}
finally {
_reply.recycle();
...
mRemote.transact(Stub.TRANSACTION_addVmsSubscriberToPublisher, _data, _reply, 0);
_reply.readException();
}
finally {
_reply.recycle();
...
_data.writeInterfaceToken(DESCRIPTOR);
_data.writeStrongBinder((((subscriber!=null))?(subscriber.asBinder()):(null)));
mRemote.transact(Stub.TRANSACTION_removeVmsSubscriberToNotifications, _data, _reply, 0);
_reply.readException();
}
finally {
_reply.recycle();
...
mRemote.transact(Stub.TRANSACTION_removeVmsSubscriber, _data, _reply, 0);
_reply.readException();
}
finally {
_reply.recycle();
...
_data.writeInterfaceToken(DESCRIPTOR);
_data.writeStrongBinder((((subscriber!=null))?(subscriber.asBinder()):(null)));
mRemote.transact(Stub.TRANSACTION_removeVmsSubscriberPassive, _data, _reply, 0);
_reply.readException();
}
finally {
_reply.recycle();
...
_data.writeInt(publisherId);
mRemote.transact(Stub.TRANSACTION_removeVmsSubscriberToPublisher, _data, _reply, 0);
_reply.readException();
}
finally {
_reply.recycle();
...
try {
_data.writeInterfaceToken(DESCRIPTOR);
mRemote.transact(Stub.TRANSACTION_getAvailableLayers, _data, _reply, 0);
_reply.readException();
if ((0!=_reply.readInt())) {
...
_data.writeInterfaceToken(DESCRIPTOR);
_data.writeInt(publisherId);
mRemote.transact(Stub.TRANSACTION_getPublisherInfo, _data, _reply, 0);
_reply.readException();
