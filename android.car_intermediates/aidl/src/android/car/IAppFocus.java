 ...
 * Original file: packages/services/Car/car-lib/src/android/car/IAppFocus.aidl
 */
package android.car;
/** @hide */
...
mRemote.transact(Stub.TRANSACTION_registerFocusListener, _data, _reply, 0);
...
_data.writeStrongBinder((((callback!=null))?(callback.asBinder()):(null)));
_data.writeInt(appType);
mRemote.transact(Stub.TRANSACTION_unregisterFocusListener, _data, _reply, 0);
_reply.readException();
}
finally {
_reply.recycle();
...
try {
_data.writeInterfaceToken(DESCRIPTOR);
mRemote.transact(Stub.TRANSACTION_getActiveAppTypes, _data, _reply, 0);
_reply.readException();
...
_data.writeStrongBinder((((callback!=null))?(callback.asBinder()):(null)));
_data.writeInt(appType);
mRemote.transact(Stub.TRANSACTION_isOwningFocus, _data, _reply, 0);
_reply.readException();
...
_data.writeStrongBinder((((callback!=null))?(callback.asBinder()):(null)));
_data.writeInt(appType);
mRemote.transact(Stub.TRANSACTION_requestAppFocus, _data, _reply, 0);
_reply.readException();
...
_data.writeStrongBinder((((callback!=null))?(callback.asBinder()):(null)));
_data.writeInt(appType);
mRemote.transact(Stub.TRANSACTION_abandonAppFocus, _data, _reply, 0);
_reply.readException();
}
finally {
_reply.recycle();
