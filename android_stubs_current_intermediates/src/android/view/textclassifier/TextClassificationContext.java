...
{
public  Builder(java.lang.String packageName, java.lang.String widgetType) { throw new RuntimeException("Stub!"); }
public  android.view.textclassifier.TextClassificationContext.Builder setWidgetVersion(java.lang.String widgetVersion) { throw new RuntimeException("Stub!"); }
public  android.view.textclassifier.TextClassificationContext build() { throw new RuntimeException("Stub!"); }
}
TextClassificationContext() { throw new RuntimeException("Stub!"); }
