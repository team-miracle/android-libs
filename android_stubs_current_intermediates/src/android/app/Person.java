...
public  android.app.Person.Builder setName(java.lang.CharSequence name) { throw new RuntimeException("Stub!"); }
public  android.app.Person.Builder setIcon(android.graphics.drawable.Icon icon) { throw new RuntimeException("Stub!"); }
public  android.app.Person.Builder setUri(java.lang.String uri) { throw new RuntimeException("Stub!"); }
public  android.app.Person.Builder setKey(java.lang.String key) { throw new RuntimeException("Stub!"); }
...
Person() { throw new RuntimeException("Stub!"); }
