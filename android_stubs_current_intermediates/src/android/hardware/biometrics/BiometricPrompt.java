...
public  android.hardware.biometrics.BiometricPrompt.Builder setTitle(java.lang.CharSequence title) { throw new RuntimeException("Stub!"); }
public  android.hardware.biometrics.BiometricPrompt.Builder setSubtitle(java.lang.CharSequence subtitle) { throw new RuntimeException("Stub!"); }
public  android.hardware.biometrics.BiometricPrompt.Builder setDescription(java.lang.CharSequence description) { throw new RuntimeException("Stub!"); }
public  android.hardware.biometrics.BiometricPrompt.Builder setNegativeButton(java.lang.CharSequence text, java.util.concurrent.Executor executor, android.content.DialogInterface.OnClickListener listener) { throw new RuntimeException("Stub!"); }
...
public  void authenticate(android.hardware.biometrics.BiometricPrompt.CryptoObject crypto, android.os.CancellationSignal cancel, java.util.concurrent.Executor executor, android.hardware.biometrics.BiometricPrompt.AuthenticationCallback callback) { throw new RuntimeException("Stub!"); }
public  void authenticate(android.os.CancellationSignal cancel, java.util.concurrent.Executor executor, android.hardware.biometrics.BiometricPrompt.AuthenticationCallback callback) { throw new RuntimeException("Stub!"); }
