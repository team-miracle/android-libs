...
{
public  SessionConfiguration(int sessionType, java.util.List<android.hardware.camera2.params.OutputConfiguration> outputs, java.util.concurrent.Executor executor, android.hardware.camera2.CameraCaptureSession.StateCallback cb) { throw new RuntimeException("Stub!"); }
...
public  void setInputConfiguration(android.hardware.camera2.params.InputConfiguration input) { throw new RuntimeException("Stub!"); }
