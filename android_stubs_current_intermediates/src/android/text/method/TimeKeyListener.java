...
public  TimeKeyListener(java.util.Locale locale) { throw new RuntimeException("Stub!"); }
...
public static  android.text.method.TimeKeyListener getInstance(java.util.Locale locale) { throw new RuntimeException("Stub!"); }
@Deprecated
