...
public  android.companion.AssociationRequest.Builder addDeviceFilter(android.companion.DeviceFilter<?> deviceFilter) { throw new RuntimeException("Stub!"); }
public  android.companion.AssociationRequest build() { throw new RuntimeException("Stub!"); }
}
AssociationRequest() { throw new RuntimeException("Stub!"); }
