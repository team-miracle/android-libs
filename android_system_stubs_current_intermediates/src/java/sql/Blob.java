...
public abstract  int setBytes(long pos, byte[] bytes) throws java.sql.SQLException;
public abstract  int setBytes(long pos, byte[] bytes, int offset, int len) throws java.sql.SQLException;
