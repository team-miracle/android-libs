...
public  void updateAppWidgetProviderInfo(android.content.ComponentName provider, java.lang.String metaDataKey) { throw new RuntimeException("Stub!"); }
...
public  java.util.List<android.appwidget.AppWidgetProviderInfo> getInstalledProvidersForPackage(java.lang.String packageName, android.os.UserHandle profile) { throw new RuntimeException("Stub!"); }
...
public  boolean requestPinAppWidget(android.content.ComponentName provider, android.os.Bundle extras, android.app.PendingIntent successCallback) { throw new RuntimeException("Stub!"); }
