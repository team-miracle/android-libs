...
public  long getAllocatableBytes(java.util.UUID storageUuid, int flags) throws java.io.IOException { throw new RuntimeException("Stub!"); }
...
@android.annotation.SuppressLint(value={"Doclava125"})
public  void allocateBytes(java.util.UUID storageUuid, long bytes, int flags) throws java.io.IOException { throw new RuntimeException("Stub!"); }
...
@android.annotation.SuppressLint(value={"Doclava125"})
public  void allocateBytes(java.io.FileDescriptor fd, long bytes, int flags) throws java.io.IOException { throw new RuntimeException("Stub!"); }
