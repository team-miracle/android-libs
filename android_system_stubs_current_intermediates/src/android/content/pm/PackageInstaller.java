...
public  void commitTransferred(android.content.IntentSender statusReceiver) { throw new RuntimeException("Stub!"); }
...
public  void setInstallAsInstantApp(boolean isInstantApp) { throw new RuntimeException("Stub!"); }
public  void setInstallAsVirtualPreload() { throw new RuntimeException("Stub!"); }
public  void setInstallReason(int installReason) { throw new RuntimeException("Stub!"); }
public  void setAllocateAggressive(boolean allocateAggressive) { throw new RuntimeException("Stub!"); }
...
public  java.lang.String[] getGrantedRuntimePermissions() { throw new RuntimeException("Stub!"); }
public  boolean getAllowDowngrade() { throw new RuntimeException("Stub!"); }
public  boolean getDontKillApp() { throw new RuntimeException("Stub!"); }
public  boolean getInstallAsInstantApp(boolean isInstantApp) { throw new RuntimeException("Stub!"); }
public  boolean getInstallAsFullApp(boolean isInstantApp) { throw new RuntimeException("Stub!"); }
public  boolean getInstallAsVirtualPreload() { throw new RuntimeException("Stub!"); }
public  boolean getAllocateAggressive() { throw new RuntimeException("Stub!"); }
public  int describeContents() { throw new RuntimeException("Stub!"); }
public  void writeToParcel(android.os.Parcel dest, int flags) { throw new RuntimeException("Stub!"); }
...
public  void setPermissionsResult(int sessionId, boolean accepted) { throw new RuntimeException("Stub!"); }
