...
public  void setSaturationLevel(float level) { throw new RuntimeException("Stub!"); }
...
public  android.graphics.Point getStableDisplaySize() { throw new RuntimeException("Stub!"); }
public  java.util.List<android.hardware.display.BrightnessChangeEvent> getBrightnessEvents() { throw new RuntimeException("Stub!"); }
public  java.util.List<android.hardware.display.AmbientBrightnessDayStats> getAmbientBrightnessStats() { throw new RuntimeException("Stub!"); }
public  void setBrightnessConfiguration(android.hardware.display.BrightnessConfiguration c) { throw new RuntimeException("Stub!"); }
public  android.hardware.display.BrightnessConfiguration getBrightnessConfiguration() { throw new RuntimeException("Stub!"); }
public  android.hardware.display.BrightnessConfiguration getDefaultBrightnessConfiguration() { throw new RuntimeException("Stub!"); }
public  android.util.Pair<float[], float[]> getMinimumBrightnessCurve() { throw new RuntimeException("Stub!"); }
