...
public  ImageSpan(android.content.Context context, android.graphics.Bitmap bitmap) { throw new RuntimeException("Stub!"); }
public  ImageSpan(android.content.Context context, android.graphics.Bitmap bitmap, int verticalAlignment) { throw new RuntimeException("Stub!"); }
public  ImageSpan(android.graphics.drawable.Drawable drawable) { throw new RuntimeException("Stub!"); }
public  ImageSpan(android.graphics.drawable.Drawable drawable, int verticalAlignment) { throw new RuntimeException("Stub!"); }
public  ImageSpan(android.graphics.drawable.Drawable drawable, java.lang.String source) { throw new RuntimeException("Stub!"); }
public  ImageSpan(android.graphics.drawable.Drawable drawable, java.lang.String source, int verticalAlignment) { throw new RuntimeException("Stub!"); }
