...
public  android.net.wifi.aware.PublishConfig.Builder setServiceName(java.lang.String serviceName) { throw new RuntimeException("Stub!"); }
public  android.net.wifi.aware.PublishConfig.Builder setServiceSpecificInfo(byte[] serviceSpecificInfo) { throw new RuntimeException("Stub!"); }
public  android.net.wifi.aware.PublishConfig.Builder setMatchFilter(java.util.List<byte[]> matchFilter) { throw new RuntimeException("Stub!"); }
