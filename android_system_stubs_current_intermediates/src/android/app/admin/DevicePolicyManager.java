...
public  boolean packageHasActiveAdmins(java.lang.String packageName) { throw new RuntimeException("Stub!"); }
...
public  android.content.ComponentName getDeviceOwnerComponentOnAnyUser() { throw new RuntimeException("Stub!"); }
@java.lang.Deprecated()
...
public  void notifyPendingSystemUpdate(long updateReceivedTime, boolean isSecurityPatch) { throw new RuntimeException("Stub!"); }
...
public  boolean isDeviceProvisioned() { throw new RuntimeException("Stub!"); }
public  void setDeviceProvisioningConfigApplied() { throw new RuntimeException("Stub!"); }
public  boolean isDeviceProvisioningConfigApplied() { throw new RuntimeException("Stub!"); }
