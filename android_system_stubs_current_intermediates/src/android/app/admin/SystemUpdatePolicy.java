...
{
InstallationOption() { throw new RuntimeException("Stub!"); }
public  int getType() { throw new RuntimeException("Stub!"); }
public  long getEffectiveTime() { throw new RuntimeException("Stub!"); }
}
...
public  android.app.admin.SystemUpdatePolicy.InstallationOption getInstallationOptionAt(long when) { throw new RuntimeException("Stub!"); }
