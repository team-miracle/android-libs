...
public  void setLocationEnabledForUser(boolean enabled, android.os.UserHandle userHandle) { throw new RuntimeException("Stub!"); }
public  boolean isLocationEnabledForUser(android.os.UserHandle userHandle) { throw new RuntimeException("Stub!"); }
public  boolean isProviderEnabled(java.lang.String provider) { throw new RuntimeException("Stub!"); }
public  boolean isProviderEnabledForUser(java.lang.String provider, android.os.UserHandle userHandle) { throw new RuntimeException("Stub!"); }
public  boolean setProviderEnabledForUser(java.lang.String provider, boolean enabled, android.os.UserHandle userHandle) { throw new RuntimeException("Stub!"); }
...
public  int getGnssBatchSize() { throw new RuntimeException("Stub!"); }
public  boolean registerGnssBatchedLocationCallback(long periodNanos, boolean wakeOnFifoFull, android.location.BatchedLocationCallback callback, android.os.Handler handler) { throw new RuntimeException("Stub!"); }
public  void flushGnssBatch() { throw new RuntimeException("Stub!"); }
public  boolean unregisterGnssBatchedLocationCallback(android.location.BatchedLocationCallback callback) { throw new RuntimeException("Stub!"); }
